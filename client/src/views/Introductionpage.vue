<template>
  <div class="container">
    ...
    <div class="row" style="background-color: #A8E6CF;">
      ...
      <div class="column-1">
        <p class="p_box">원시시대에 그림은 인간의 언어였습니다. 벽화나 토기에 새겨진 그림이 그들의 의사표현이었고 그들의 감정과 행동의 기록이었습니다.
          <br><br>
          ...
          <br><br>
          그림검사를 통해 <span class="htp-text-2">언어로 표현하기 어려운 심상(image)</span>을 그림으로 표현하게 하여 사람을 더욱 이해할 수 있도록 돕는 비언어적 커뮤니케이션이 가능합니다.</p>
      </div>
    </div>
    <div class="row" style="background-color: #DCEDC1;">
      <div class="column-1">
        <p class="p_box">HTP검사는 <span class="htp-text-3">House(집), Tree(나무), Person(사람)</span>을 그려보게 하는 그림검사입니다. 한 종이에 모두 그려넣는 KHTP검사가 있고 사람그림을 남,녀 양성을 모두 그리게 하는 HTPP검사가 있습니다. HTP 검사는 1920년대에 <span class="htp-text-3">구디너프(Goodenough, 1926)</span>가 고안한 <span class="htp-text-3">인물화 검사(Drawing a Person Test, DAP)</span>를 바탕으로, <span class="htp-text-3">존 벅(John Buck)</span>이 1948년에 집과 나무를 추가로 그리도록 재개발하였습니다.
          ...
          <br><br>
          HTP그림검사는 사용상의 여러 가지 이점들이 있는데, 실시가 쉽고(연필, 종이, 지우개) <span class="htp-text-3">시간이 많이 걸리지 않으며</span>(보통 20~30분) 언어 표현이 어려운 사람(아동, 외국인, 문맹자들)도 실시가능하며 그림 솜씨나 훈련이 성격 평가에 큰 영향을 주지 않습니다.
          <br><br>
          HTP그림의 해석은, 정신분석에서 밝혀진 상징에 대한 의미, 정신증 환자들이 보이는 <span class="htp-text-3">방어기제</span>와 <span class="htp-text-3">강박적 사고</span>, <span class="htp-text-3">강박적 행동</span>, <span class="htp-text-3">공포와 불안</span> 등의 여러 병리적 현상에서 나타나는 상징성을 연구하며 얻은 단서들을 해석에 적용해 왔습니다.</p>
      </div>
      <div class="column">
    ...
    <div class="row" style="background-color: #FFD3B6;">
      ...
      <div class="column-1">
        <p>그림투사검사의 장점</p>
        <p class="p_box">
          1. 그림검사는 <span class="htp-text-4">설문지형 검사</span>보다 피검자들의 <span class="htp-text-4">부담</span>이 적다.
          <br>
          2. 그림검사는 그려진 그림을 통해 그린 사람의 <span class="htp-text-4">심상의 표현</span>을 볼 수 있다.
          <br>
          3. 그림검사는 비언어적커뮤니케이션이므로 통제나 방어를 줄여준다.
          <br>
          ...
          <br>
          8. 그림검사를 집단으로 실시하여 집단원들의 <span class="htp-text-4">적응수준</span>이나 <span class="htp-text-4">성격</span>의 <span class="htp-text-4">성숙도</span>를 알아 볼 수 있다.</p>
      </div>
    </div>
    <div class="row" style="background-color: #FFAAA5;">
      <div class="column-1">
        <p class="p_box">HTP 검사를 진행하는 방법을 다음과 같이 안내드립니다.
          <br><br>
          1. <span class="htp-text-5">회원 가입</span>: 먼저 사이트에 회원 가입을 해주세요.
          <br>
          2. <span class="htp-text-5">로그인</span>: 가입한 계정으로 로그인합니다.
          <br>
          3. <span class="htp-text-5">검사 시작</span>: 로그인 후, '검사 시작' 버튼을 눌러주세요.
          <br>
          4. <span class="htp-text-5">이미지 업로드</span>: 카메라를 이용하여 자녀가 그린 그림을 촬영합니다. 각 그림이 집, 나무, 사람을 잘 나타내도록 구분하여 파일을 업로드 해주세요.
          <br>
          5. <span class="htp-text-5">결과 확인</span>: 업로드가 완료되면 검사 결과를 확인할 수 있습니다.
          <br>
          6. <span class="htp-text-5">마이페이지 확인</span>: 마이페이지에서도 검사 결과를 언제든지 확인할 수 있습니다.
          <br><br>
          이 과정을 통해 <span class="htp-text-5">HTP 검사 결과를 간편하게</span> 받아보실 수 있습니다.</p>
      </div>
      <div class="column">
...
export default {
  data() {
    return {
      ...
      imgSrc4: require('@/images/istockphoto-1428116743-612x612.jpg')
    };
  }
};
</script>
